...
public abstract class EditableOverlayActivityBase extends Activity {
	...
	private class MyMapEventListener extends MapEventListener {
		...
		public void onVectorElementClicked(VectorElementsClickInfo vectorElementsClickInfo) {
			...
			editableLayer.setSelectedVectorElement(mapClickInfo.getVectorElement());
		}		
	}
    ...
    private void modifyElementProperties(final VectorElement element) {
        ...
        final StringMap metaData = element.getMetaData();
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                propBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int button) {
                    	metaData.set(key, input.getEditableText().toString());
